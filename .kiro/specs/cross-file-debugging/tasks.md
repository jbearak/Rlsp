...
- [ ] 1. Add comprehensive logging infrastructure
  - [ ] 1.1 Add logging to metadata extraction (source_detect.rs, directive.rs)
  ...
  - [ ] 1.2 Add logging to dependency graph operations (dependency.rs)
  ...
  - [ ] 1.3 Add logging to path resolution (path_resolve.rs)
  ...
  - [ ] 1.4 Add logging to scope resolution (scope.rs)
  ...
  - [ ] 1.5 Add logging to LSP handlers (handlers.rs)
  ...
  - [ ] 1.6 Add logging to configuration initialization (config.rs, main.rs)
...
- [ ] 2. Create test infrastructure and helper utilities
  - [ ] 2.1 Create TestWorkspace helper struct
  ...
  - [ ] 2.2 Create VerificationReport helper struct
  ...
  - [ ] 2.3 Create integration test module (cross_file/integration_tests.rs)
...
- [ ] 3. Implement real-world failure reproduction tests
  - [ ] 3.1 Implement validation_functions/collate.r test case
  ...
  - [ ] 3.2 Implement backward directive ../oos.r test case
  ...
  - [ ] 3.3 Implement basic source() call test case
...
- [ ] 4. Checkpoint - Run tests and analyze logs
...
- [ ] 10. Investigate and fix LSP handler integration
  - [ ] 10.1 Verify handlers call cross-file functions
  ...
  - [ ] 10.2 Verify document lifecycle triggers metadata extraction
  ...
  - [ ] 10.3 Fix any integration issues found
...
- [ ] 16. Final integration testing and verification
  - [ ] 16.1 Run all integration tests
  ...
  - [ ] 16.3 Test with real VS Code extension

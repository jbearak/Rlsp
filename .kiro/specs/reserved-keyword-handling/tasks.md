...
- [ ] 1. Create Reserved Word Module
  - [ ] 1.1 Create `crates/raven/src/reserved_words.rs` with `RESERVED_WORDS` constant and `is_reserved_word()` function
  ...
  - [ ] 1.2 Add module declaration to `crates/raven/src/lib.rs`
    - Add `pub mod reserved_words;` to expose the module
    - _Requirements: 1.3_
  
  - [ ] 1.3 Write property test for reserved word identification
    - **Property 1: Reserved Word Identification**
    - **Validates: Requirements 1.1, 1.2**

- [ ] 2. Modify Definition Extraction
  - [ ] 2.1 Update `try_extract_assignment` in `crates/raven/src/cross_file/scope.rs`
  ...
  - [ ] 2.2 Write property test for definition extraction exclusion
    - **Property 2: Definition Extraction Exclusion**
    - **Validates: Requirements 2.1, 2.2, 2.3, 2.4**

- [ ] 3. Modify Undefined Variable Checker
  - [ ] 3.1 Update `collect_undefined_variables_position_aware` in `crates/raven/src/handlers.rs`
  ...
  - [ ] 3.2 Write property test for undefined variable check exclusion
...
- [ ] 5. Modify Completion Provider
  - [ ] 5.1 Update `completion` function in `crates/raven/src/handlers.rs`
  ...
  - [ ] 5.2 Write property test for completion exclusion
    - **Property 4: Completion Exclusion**
    - **Validates: Requirements 5.1, 5.2, 5.3**

- [ ] 6. Modify Document Symbol Provider
  - [ ] 6.1 Update `collect_symbols` function in `crates/raven/src/handlers.rs`
    - Add reserved word check before adding symbol to list
    - Skip reserved words but continue recursion
    - _Requirements: 6.1, 6.2_
  
  - [ ] 6.2 Write property test for document symbol exclusion

...
describe('assignment onEnterRule (#611)', () => {
    ...
    const doesNotFire = [
        ...
        'x = 1',
        'x <- "a <-"',
        // R 4.6.1 rejects escaped backticks in backquoted names as a syntax error.
        '`a\\`b` <-',
        'f(x =',
    ];
...
/**
 * `rmd`/`quarto` use `rmd-language-configuration.json`, generated by
 * `editors/vscode/scripts/generate-rmd-language-config.mjs` from the R
 * configuration with the assignment onEnterRule removed: `beforeText` regexes
